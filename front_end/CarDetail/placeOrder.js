...
function showNotification() {
  ...
  <span>You have already placed an order!<button class="order-detail" onclick="window.location.href='/front_end/Order/OrderList/orderList.html'">See detail</button></span> 
