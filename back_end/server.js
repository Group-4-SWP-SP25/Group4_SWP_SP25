...
// car
const getCarByID = require("./myModule/database/car/getCarByID.js");

// order
const listOrders = require("./myModule/controller/order/listOrder.js");
...
// car
app.post("/getCarByID", getCarByID);

// order
app.post("/listOrders", authenticateJWT, listOrders);
